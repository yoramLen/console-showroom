...
export const Wrapper = styled.div`
  ...
  .consoles {
    ...
    width: 100%;
    padding: 2rem 5%;
    background-color: ${({ consolesColor = COLORS.PRIMARY }) =>
      `${consolesColor}`};
...
export const Console = styled(Link)`
  display: flex;
  position: relative;
  width: 22vw;
  height: 22vw;
...
export const BottomEdgeDown = styled.div`
  ...
  border-right: 96.7vw solid transparent;
...
export const BottomEdgeUp = styled.div`
  ...
  &:after {
    ...
    display: block;
    border-bottom: ${({ color }) => `100px solid ${color}`};
    border-left: 96.7vw solid transparent;
